...
class TestTurtle(unittest.TestCase):
    ...
    def test_branching(self):
        ...
        self.assertAlmostEqual(pl1[0][0], 0); self.assertAlmostEqual(pl1[0][1], 0)
        self.assertAlmostEqual(pl1[1][0], 10); self.assertAlmostEqual(pl1[1][1], 0)
        self.assertAlmostEqual(pl1[2][0], 10); self.assertAlmostEqual(pl1[2][1], 10) # +90 deg is +Y? Let's check angle/direction conventions.
